...
namespace {
  ...
  namespace Factory {
    ...
    DiscoveredReaderData default_reader_data()
    {
      ...
      reader_data.readerProxy.remoteReaderGuid = GUID_UNKNOWN;
    ...
    reader_data(
      ...
      result.ddsSubscriptionData.time_based_filter = TheServiceParticipant->initial_TimeBasedFilterQosPolicy();
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_one_locator)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_two_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_three_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_four_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_user_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_user_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_protocol_version)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_protocol_version)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_vendor_id)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_vendor_id)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_guid_prefix)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_guid_prefix)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_expects_inline_qos)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_expects_inline_qos)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_builtin_endpoints)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_builtin_endpoints)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_meta_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_meta_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_meta_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_meta_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_default_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_default_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_default_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_default_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_liveliness_count)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_liveliness_count)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_participant_lease_duration)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_participant_lease_duration)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_participant_user_data_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_participant_expects_inline_qos_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_participant_lease_duration_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, ignore_participant_vendor_specific_parameters)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, dont_fail_on_participant_optional_parameters)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, fail_on_participant_required_parameters)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, pid_builtin_endpoint_set_bug)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, ignore_participant_sentinel)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, ignore_participant_pad)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_topic_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_topic_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_topic_name_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_type_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_type_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_topic_type_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_durability_qos)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_durability_qos)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_durability_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_durability_service)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_durability_service_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_deadline)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_latency_budget)
{ // Should encode writer latency budget
  DiscoveredWriterData writer_data = Factory::writer_data(
                                                          0, 0, VOLATILE_DURABILITY_QOS, 0, 0,
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_latency_budget_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_liveliness)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_reliability)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_lifespan)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_user_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_user_data_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_ownership)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_ownership)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_ownership_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_ownership_strength)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_ownership_strength_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_destination_order)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_destination_order)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_destination_order_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_presentation)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_presentation)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_presentation_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_partition)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_partition)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_partition_default)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_topic_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_topic_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_topic_data_default)
{ // Should set writer topic data to default if not present in param list
  const char* topic_data = "TEST TD";
  DiscoveredWriterData writer_data_out = Factory::writer_data(
                                                              0, 0, VOLATILE_DURABILITY_QOS, 0, 0,
                                                              KEEP_LAST_HISTORY_QOS, 1, 1, 1, 1, 0, 0, 0, 0,
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_group_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_group_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_writer_group_data_default)
{ // Should set writer group data to default if not present in param list
  const char* group_data = "TEST GD";
  DiscoveredWriterData writer_data_out = Factory::writer_data(
                                                              0, 0, VOLATILE_DURABILITY_QOS, 0, 0,
                                                              KEEP_LAST_HISTORY_QOS, 1, 1, 1, 1, 0, 0, 0, 0,
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_guid)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_guid)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_unicast_allocators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_writer_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_writer_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_topic_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_topic_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_type_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_type_name)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_durability)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_durability)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_deadline)
...
{ // Should encode reader latency budget
  DiscoveredReaderData reader_data = Factory::reader_data(
                                                          0, 0, VOLATILE_DURABILITY_QOS, 0, 0,
                                                          5, 25000);
  ParameterList param_list;
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_liveliness)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_user_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_ownership)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_ownership)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_destination_order)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_destination_order)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_presentation)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_presentation)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_partition)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_partition)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_topic_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_topic_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_group_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_group_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_guid)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_guid)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_unicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_multicast_locators)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_reader_content_filter_property)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, decode_reader_content_filter_property)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, encode_decode_reader_associated_guid_list)
{ // Should encode/decode reader associated guid list properly
  DiscoveredReaderData reader_data = Factory::reader_data(
                                                          0, 0, VOLATILE_DURABILITY_QOS, 0, 0, 0, 0,
                                                          AUTOMATIC_LIVELINESS_QOS, 0, 0,
                                                          BEST_EFFORT_RELIABILITY_QOS, 0, 0, 0, 0,
  ...
  DiscoveredReaderData reader_data_out;
  from_param_list(param_list, VENDORID_OPENDDS, reader_data_out, true, type_info.xtypes_type_info_);
...
TEST(dds_DCPS_RTPS_ParameterListConverter, set_reader_defaults)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, dont_encode_participant_default_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, dont_encode_writer_default_data)
...
TEST(dds_DCPS_RTPS_ParameterListConverter, dont_encode_reader_default_data)
